...
Selected skills also come from [mattpocock/skills](https://github.com/mattpocock/skills) (`9c9f36c`, MIT © 2026 Matt Pocock) and [cursor/plugins](https://github.com/cursor/plugins) `pstack/` (`60c641e`, MIT © 2026 Lauren Tan). Full plugins are not installed.
...
| Matt Pocock selected skills (`diagnosing-bugs`, `domain-modeling`, `codebase-design`, `writing-for-agents`, `research`, `prototype`, `grilling`, `improve-codebase-architecture`, `wizard`, `wait-what`) | mattpocock/skills `9c9f36c` | MIT — `vendor/licenses/MATT-POCOCK-MIT.txt` | follow MIT |
...
| Remaining skills (`ask-matt`, `browser-act`, `chrome-devtools-axi`, `emil-design-eng`, `found-this-design`, `full-audit-keamanan`, `full-performance-audit`, `gh-axi`, `grill-with-docs`, `matt-code-review`, `matt-implement`, `scroll-world`, `tdd`, `to-spec`, `to-tickets`, `visual-studio`) | adapted snapshot; no license in SKILL.md frontmatter | **not stated** | **unknown** — not a grant |
