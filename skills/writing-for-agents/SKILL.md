...
- **Over-Explained Comment**: a multi-line comment around a one-line fact is slop. State the why in one clear line; omit restatements of what the code already says.
- **Decorative Banners**: decorative `// ====` banners and divider blocks are slop.
- When cleaning comments, do not touch executable code, identifiers, or control flow.
